StartTest(function (t) {
  ...
  t.it('Should be possible to pass task instance to from/to fields when create a new dependency', function (t) {
    createStores();
    var dependency = dependencyStore.add({
  ...
  t.it('Should be possible to pass task instance to fromEvent/toEvent fields when create a new dependency', function (t) {
    createStores();
    var dependency = dependencyStore.add({
  ...
  t.it('Should be possible to pass task instance to fromTask/toTask fields when create a new dependency', function (t) {
    createStores();
    var dependency = dependencyStore.add({
