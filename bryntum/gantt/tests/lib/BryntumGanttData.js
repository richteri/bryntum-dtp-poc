...
Role('BryntumGanttData', {
    ...
    methods : {
        ...
        getAssignmentStoreData : function() {
            return [
                { 'id' : 1,  'resource' : 1,  'event' : 115, 'units' : 100 },
                { 'id' : 2,  'resource' : 2,  'event' : 116, 'units' : 100 },
                { 'id' : 3,  'resource' : 3,  'event' : 117, 'units' : 100 },
                { 'id' : 4,  'resource' : 4,  'event' : 118, 'units' : 100 },
                { 'id' : 5,  'resource' : 5,  'event' : 119, 'units' : 100 },
                { 'id' : 6,  'resource' : 6,  'event' : 120, 'units' : 100 },
                { 'id' : 7,  'resource' : 7,  'event' : 121, 'units' : 100 },
                { 'id' : 8,  'resource' : 8,  'event' : 115, 'units' : 10 },
                { 'id' : 9,  'resource' : 9,  'event' : 116, 'units' : 25 },
                { 'id' : 10, 'resource' : 10, 'event' : 117, 'units' : 50 },
                { 'id' : 11, 'resource' : 11, 'event' : 118, 'units' : 75 },
                { 'id' : 12, 'resource' : 12, 'event' : 119, 'units' : 90 }
            ];
        },

        getDependencyStoreData : function() {
            return [
                { 'fromEvent' : 117, 'toEvent' : 115, 'id' : 30, 'type' : 2 },
                { 'fromEvent' : 118, 'toEvent' : 115, 'id' : 31, 'type' : 2 },
                { 'fromEvent' : 115, 'toEvent' : 116, 'id' : 32, 'type' : 2 },
                { 'fromEvent' : 121, 'toEvent' : 120, 'id' : 33, 'type' : 2 }
            ];
        },
        ...
        getTaskStore : function(config, doNotLoad) {
            ...
            let data = config.DATA || this.getTaskStoreData();

            return new this.global.TaskStore(Object.assign({ data : data }, config));
        },

        getTeamResourceStore : function(config) {
            return new this.global.ResourceStore(Object.assign({
                data : this.getResourceStoreData()
            }, config));
        },

        getTeamAssignmentStore : function(config) {
