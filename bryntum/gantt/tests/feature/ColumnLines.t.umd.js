StartTest(function (t) {
  ...
  function assertColumnLines(t) {
    t.is(document.querySelector('.b-sch-background-canvas').offsetWidth, // In IE11 rows width does not match timeaxis width, but because it does not seem to affect functionality
  ...
  t.it('ColumnLines feature should work in Gantt', function (t) {
    gantt = t.getGantt({
