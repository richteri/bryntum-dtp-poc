...
StartTest(t => {
    ...
    t.it('Sanity checks', t => {
        ...
        t.chain(
            ...
            { waitFor : () =>  !node2.isLeaf &&
                    node2.startDate.valueOf() === new Date(2010, 0, 1).valueOf() &&
                    node2.endDate.valueOf() === new Date(2010, 0, 3).valueOf()
            },
            ...
            // Wait for propagation to fix things
            { waitFor : () =>  node4.parent === node2 &&
                node2.startDate.valueOf() === new Date(2010, 0, 1).valueOf() &&
                node2.endDate.valueOf() === new Date(2010, 0, 7).valueOf()
            },
    ...
    t.it('Indent non-indentable node using UI must be no-op', t => {
    ...
    t.it('Indent non-indentable node using API must be no-op', t => {
        var taskStore = getGantt({
            project : {
                startDate  : '2010-01-01',
                eventsData : [
    ...
    t.it('Indent with dependencies linking a child-parent after move using UI must be reverted', t => {
        var taskStore = getGantt({
            project : {
                startDate  : '2010-01-01',
                eventsData : [
    ...
    t.it('Indent with dependencies linking a child-parent after move using API must be reverted', t => {
        var taskStore = getGantt({
            project : {
                startDate  : '2010-01-01',
                eventsData : [
    ...
    t.it('Indent with dependencies where a cycle is created using UI must be reverted.', t => {
        var taskStore = getGantt({
            project : {
                startDate  : '2010-01-01',
                eventsData : [
    ...
    t.it('Indent with dependencies where a cycle is created using API must be reverted.', t => {
        var taskStore = getGantt({
            project : {
                startDate  : '2010-01-01',
                eventsData : [
