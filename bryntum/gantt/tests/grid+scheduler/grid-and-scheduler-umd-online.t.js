...
StartTest(t => {
    ...
    t.chain(
        ...
        { waitForSelector : '.b-gantt#gantt', desc : 'Gantt element found' },

        { rightClick : '#grid .b-grid-cell', desc : 'grid: trigger element added to float root'},
        { rightClick : '#scheduler .b-timeline-subgrid', desc : 'scheduler: trigger element added to float root'},
        { rightClick : '#gantt .b-grid-header-text', desc : 'gantt: trigger element added to float root'},
