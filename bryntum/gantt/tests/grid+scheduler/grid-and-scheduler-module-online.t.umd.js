...
import { Scheduler } from 'https://bryntum.com/examples/build/scheduler.module.js';
/*KEEP*/

import { Gantt } from '../../build/gantt.module.js'; // NOTE: Any changes here should also be applied to grid-and-scheduler-module.t.js
...
StartTest(function (t) {
  ...
  new Scheduler({
    ...
    id: 'scheduler',
    cls: 'b-gridbase',
    // Need  this while online version is behind
    width: 1024,
    height: 300,
    resources: [{
      id: 1,
