 ...
 * @Last Modified time: 2019-12-31 01:00:39
 */
StartTest(t => {
    t.it('Rendering', t => {
        t.chain(
    ...
    t.it('Task Editor', t => {
        t.chain(
            ...
            { waitForSelector : '.b-tabpanel-tab-title:textEquals(Common)', desc : 'Should have Common tab' },
            { waitForSelector : '.b-tabpanel-tab-title:textEquals(Files)', desc : 'Should have Files tab' },
            { waitForSelector : '.b-textfield label:textEquals(Deadline)', desc : 'Should have Deadline field' },
            { waitForSelector : '.b-textfield label:textEquals(Color)', desc : 'Should have Color field' },
            { waitForSelectorNotFound : 'b-tabpanel-tab-title:textEquals(Notes)', desc : 'Shouldn\'t have Notes tab' },
            { click : '[name="name"]' },
