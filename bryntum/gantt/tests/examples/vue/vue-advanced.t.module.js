describe('Test buttons', function(t) {
    ...
    t.it('Check toolbar buttons', (t) => {
        ...
        const
            checkToolTip = (t, button, text, x, y, width, height) => [
                ...
                (next) => {
                    ...
                    t.isApprox(bounds.left, x, 7, 'Correct tooltip x');
        ...
        t.chain(
            checkToolTip(t, buttons.addTaskButton, 'Create new task', 0, 55, 127, 47),

            checkToolTip(t, buttons.editTaskButton, 'Edit selected task', 87, 55, 135, 47),
