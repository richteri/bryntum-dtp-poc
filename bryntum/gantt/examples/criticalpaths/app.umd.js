...
var _bryntum$gantt = bryntum.gantt,
    ...
    ProjectModel = _bryntum$gantt.ProjectModel; // Extend default Task model class to provide additional CSS class
...
var Task = /*#__PURE__*/function (_TaskModel) {
  ...
  _createClass(Task, [{
    ...
    get: function get() {
      ...
      return Object.assign(_get(_getPrototypeOf(Task.prototype), "cls", this), {
