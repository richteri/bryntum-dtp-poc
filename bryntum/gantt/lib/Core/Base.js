...
export default class Base {
    ...
    static getConfigDescriptor(shallow) {
        ...
        let configDescriptor = !shallow && hasOwnProperty.call(me, defaultConfigSymbol) ? me[defaultConfigSymbol] : null,
        ...
        if (!configDescriptor) {
            ...
            configDescriptor = {
                defaultConfig : defaults = hasOwnProperty.call(me, 'defaultConfig') ? me.defaultConfig : {},
    ...
    getProperties() {
        ...
        for (i = 0; i < len; i++) {
            ...
            if (hasOwnProperty.call(cls, 'properties')) {
    ...
    static createPropInitializer(key) {
        ...
        if (!result) {
            const initializingFlagName = 'initializing' + StringHelper.capitalizeFirstLetter(key);
    ...
    classHierarchy(topClass) {
        let cls = this.constructor,
            fullClassHierarchy = hasOwnProperty.call(cls, classHierarchySymbol) ? cls[classHierarchySymbol] : null,
            result;
