...
export default class Popup extends Panel {
    ...
    close() {
         ...
         * @event beforeClose
         * @param {Core.widget.Popup} source - me Popup
         */
        if ((!me._hidden && me.trigger('beforeClose') !== false) ||
            ...
            // Focus moves unrelated to where the user's attention is upon me gesture.
            // Go into the keyboard mode where the focused widget gets a rendition so that
            // it is obvious where focus now is.
            // Must jump over EventHelper's global mousedown listener which will remove me class.
            if (me.containsFocus) {
