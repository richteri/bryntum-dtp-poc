...
export default class CalendarPanel extends Panel {
    ...
    construct(config) {
        ...
        calculateDayNames();
        // initialize weekStartDay to have canonicalDayNumbers calculated
        me.weekStartDay = config && config.weekStartDay || null;
    ...
    refresh() {
        ...
        for (let columnIndex = 0; columnIndex < 7; columnIndex++) {
            ...
            if (me.headerRenderer) {
                me.headerRenderer(cell, columnIndex);
            }
            else {
                cell.innerHTML = shortDayNames[cellDay];
            }
        ...
        month.eachWeek((week, dates) => {
            const
                weekElement = weekElements[weekIndex],
    ...
    get weekStartDay() {
        return this._weekStartDay != null ? this._weekStartDay : DateHelper.weekStartDay;
    }
