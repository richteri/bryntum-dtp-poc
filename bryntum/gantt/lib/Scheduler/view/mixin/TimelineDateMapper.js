...
export default Target => class TimelineDateMapper extends (Target || Base) {
    ...
    getDateFromDomEvent(e, roundingMethod, allowOutOfRange = false) {
        return this.getDateFromXY([e.clientX, e.clientY], roundingMethod, false, allowOutOfRange);
    }
    ...
    get viewportCenterDate() {
        ...
        if (timeAxis.isContinuous) {
            ...
            const
                scrollCenter = me.isHorizontal ? (centerX / scroller.scrollWidth) : (centerY / scroller.scrollHeight),
            ...
            const
                xy = me.isHorizontal ? [centerX, 0] : [0, centerY];
