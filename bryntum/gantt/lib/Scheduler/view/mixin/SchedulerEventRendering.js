        ...
        if (renderData) {
            ...
            if (eventRecord.isEvent || eventRecord.isTask) {
                ...
                if (renderData.eventColor && renderData.eventColor.startsWith('#')) {
                    ...
                    if (renderData.eventStyle === 'colored') {
                        const colorWithOpacity = renderData.eventColor + (renderData.eventColor.length === 4 ? '4' : '44');

                        // Add background with opacity based on hex eventColor
                        renderData.style = `background-color:${colorWithOpacity};` + renderData.style;
                    }
                }
                else {
