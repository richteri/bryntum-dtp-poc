    ...
    scrollUnrenderedEventIntoView(resourceRec, eventRec, options = defaultScrollOptions) {
        ...
        return new Promise(resolve => {
            ...
            const
                ...
                onEventPaint = ({ scheduler, eventRecord, resourceRecord, element, targetElement }) => {
                    if (eventRecord === eventRec) {
                        ...
                        initialScrollPromise.then(() => {
                            ...
                            if (delta > 0) {
                                scroller.scrollIntoView(el, { edgeOffset : options.edgeOffset });
                            }
                ...
                detatcher = me.on({
                    renderEvent  : onEventPaint, // Vertical fires this one
