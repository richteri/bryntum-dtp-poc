            ...
            meta.gridCache && me._dependencyGridCache && meta.gridCache.forEach(([x, y]) => {
                if (me._dependencyGridCache.hasOwnProperty(x) && me._dependencyGridCache[x].hasOwnProperty(y)) {
                    const
                        ...
                        index   = me.findDependencyIndex(entries, dependency, assignmentData);
            ...
            assignments.forEach(assignmentData => {
                ...
                if (me.getTimeSpanRecordFromDependency(dep, true) === eventRecord) {
                    ...
                    if ((bounds = dep.instanceMeta(metaId).bounds)) {
                        ...
                        if (box) {
                            // TODO: clean up!
                            endRectangle = box instanceof Rectangle ? box : new Rectangle(
                                box.start,
                                box.top,
                                box.end - box.start,
                                box.bottom - box.top
                    ...
                    if ((bounds = dep.instanceMeta(metaId).bounds)) {
                        ...
                        if (box) {
                            // TODO: clean up!
                            startRectangle = box instanceof Rectangle ? box : new Rectangle(
                                box.start,
                                box.top,
                                box.end - box.start,
                                box.bottom - box.top
