...
/**
 * Adds scheduler specific menu items to the timeline header context menu. Can be populated by other features.
 *
 * By default the menu has the following items:
 * * Filter tasks - provided by the {@link Scheduler.feature.EventFilter EventFilter} feature, enabled if the feature is enabled
 * * Zoom - provided by the context menu feature, always enabled by default
 * * Date range - provided by the context menu feature, always enabled by default
 *
