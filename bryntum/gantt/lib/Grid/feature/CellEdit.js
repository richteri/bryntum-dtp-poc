...
export default class CellEdit extends Delayable(InstancePlugin) {
    ...
    static get defaultConfig() {
        return {
            ...
            /**
             * The name of the event that will trigger cell editing (e.g. 'celldblclick' or 'cellclick').
             * As example, may be useful to change celldblclick to cellclick.
             * @config {String}
             * @default
             */
    ...
    getEditorForCell({ cell, column, selector, editor }) {
        ...
        let leftOffset = 0; // Only applicable for tree cells to show editor right of the icons etc
