...
(function () {
  var targetElement = document.querySelector('div[data-file="gantt/taskcontextmenu.js"] .external-target'); // User may already have navigated away from the documentation part that shows the example
