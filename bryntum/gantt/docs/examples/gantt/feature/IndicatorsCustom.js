(function () {
    ...
    const targetElement = document.querySelector('div[data-file="gantt/feature/IndicatorsCustom.js"] .external-target');
    ...
    targetElement.innerHTML = '<p>This demo shows a custom indicator:</p>';
