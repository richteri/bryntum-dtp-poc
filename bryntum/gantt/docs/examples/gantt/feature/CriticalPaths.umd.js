(function () {
  var targetElement = document.querySelector('div[data-file="gantt/feature/CriticalPaths.js"] .external-target'); // User may already have navigated away from the documentation part that shows the example

  if (!targetElement) return;
  targetElement.innerHTML = '<p>This demo shows the critical paths visualizing feature:</p>'; //START
  ...
  gantt.features.criticalPaths.disabled = false; //END
})();