...
const targetElement = document.querySelector('div[data-file="gantt/feature/CellEdit.js"] .external-target');
...
const panel = new bryntum.gantt.Panel({
    ...
    tbar : [{
        ...
        text : 'Edit',
        onClick : ({ source }) => {
            const gantt = source.parent.parent.widgetMap.gantt;
