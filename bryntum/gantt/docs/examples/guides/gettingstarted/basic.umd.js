(function () {
  var targetElement = document.querySelector('div[data-file="guides/gettingstarted/basic.js"]'); // User may already have navigated away from the documentation part that shows the example
