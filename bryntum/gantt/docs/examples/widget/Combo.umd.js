(function () {
  var targetElement = document.querySelector('div[data-file="widget/Combo.js"] .external-target'); // User may already have navigated away from the documentation part that shows the example
  ...
  new Combo({
    ...
    items: ['BASIC', 'COBOL', 'FORTRAN', 'DBL', 'SQL', 'C/C++', 'Java', 'Javascript'],
    appendTo: targetElement,
    width: '30em'
  }); //END
})();