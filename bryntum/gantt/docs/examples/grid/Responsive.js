(function () {
    const outerElement = document.querySelector('div[data-file="grid/Responsive.js"] .external-target');
...
<div id="responsive-container" style="position: relative"></div>`;
    const targetElement = outerElement.querySelector('#responsive-container');
//START
