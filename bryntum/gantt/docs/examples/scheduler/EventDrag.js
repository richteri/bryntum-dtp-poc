...
(function() {
    const targetElement = document.querySelector('div[data-file="scheduler/EventDrag.js"] .external-target');

    // User may already have navigated away from the documentation part that shows the example
    if (!targetElement) return;

    targetElement.innerHTML = '<p>This demo only allows dragging within an events resource:</p>';
//START
