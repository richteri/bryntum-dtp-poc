(function () {
const targetElement = document.querySelector('div[data-file="feature/CellEdit.js"] .external-target');

// User may already have navigated away from the documentation part that shows the example
if (!targetElement) return;

targetElement.innerHTML = '<p>Double click a cell to start editing, or select it and press Enter</p>';
//START
